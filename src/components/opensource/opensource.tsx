      ...
      <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
        ...
        <div className="space-y-6">
          {openSourceContributions.map((contrib) => (
            ...
            >
              <div className="px-4 py-3 sm:px-6 sm:py-4 border-b border-[var(--color-border)] flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              ...
              <div className="divide-y divide-[var(--color-border)]">
                {contrib.prs.map((pr) => (
                  <div key={pr.number} className="px-4 py-3 sm:px-6 flex items-start gap-3 sm:gap-4 hover:bg-[var(--color-bg-card-hover)] transition-colors">
